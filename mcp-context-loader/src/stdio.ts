...
import { loadEnvConfig, createLogger } from "@moonklabs/mcp-common";
...
async function main(): Promise<void> {
  ...
  // 2. 로거 생성 (stderr로 출력 - stdout은 MCP 통신용)
  ...
  logger.info({ transport: "stdio" }, `${SERVER_NAME} v${SERVER_VERSION} started`);
}
